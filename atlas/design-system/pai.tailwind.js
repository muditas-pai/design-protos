  ...
  theme: {
    extend: {
      colors: {
        ...
        "app-50": "var(--app-50)",   // held, brand tint
        "app-75": "var(--app-75)",
        "app-100": "var(--app-100)",
        "app-200": "var(--app-200)",
        "app-300": "var(--app-300)",
        "app-400": "var(--app-400)",
        "app-500": "var(--app-500)",  // held, Brand Blue
        "app-600": "var(--app-600)",  // held, brand companion (= text-brand / bg-brand)
        "app-650": "var(--app-650)",
        "app-700": "var(--app-700)",  // held, brand companion (hover)
        "app-800": "var(--app-800)",
        "app-900": "var(--app-900)",  // held
        ...
        "bg-primary-inverted": "var(--bg-primary-inverted)",
        "bg-primary-inverted-hover": "var(--bg-primary-inverted-hover)",
        "bg-secondary": "var(--bg-secondary)",
        "bg-default-secondary": "var(--bg-secondary)",
        "bg-secondary-inverted": "var(--bg-secondary-inverted)",
        "bg-tertiary": "var(--bg-tertiary)",
        "bg-default-tertiary": "var(--bg-tertiary)",
        ...
        "bg-tertiary-inverted": "var(--bg-tertiary-inverted)",
        "bg-quaternary": "var(--bg-quaternary)",
        "bg-elevated": "var(--bg-elevated)",
        "bg-elevated-hover": "var(--bg-elevated-hover)",
        "bg-elevation-hover": "var(--bg-elevation-hover)",
        "bg-brand": "var(--bg-brand)",
        "bg-brand-hover": "var(--bg-brand-hover)",
        "bg-brand-pressed": "var(--bg-brand-pressed)",
        "bg-brand-selected": "var(--bg-brand-selected)",
        "bg-brand-inverted": "var(--bg-brand-inverted)",
        "bg-danger": "var(--bg-danger)",
        "bg-danger-hover": "var(--bg-danger-hover)",
        "bg-danger-pressed": "var(--bg-danger-pressed)",
        "bg-danger-inverted": "var(--bg-danger-inverted)",
        "bg-warning": "var(--bg-warning)",
        "bg-warning-inverted": "var(--bg-warning-inverted)",
        "bg-success": "var(--bg-success)",
        "bg-success-inverted": "var(--bg-success-inverted)",
        "bg-info": "var(--bg-info)",
        "bg-info-inverted": "var(--bg-info-inverted)",
        "bg-blackout": "var(--bg-blackout)",
        ...
        "text-inverted-secondary": "var(--text-inverted-secondary)",
        "text-danger-primary": "var(--text-danger-primary)",
        "text-danger-hover": "var(--text-danger-hover)",
        "text-danger-secondary": "var(--text-danger-secondary)",
        ...
        "border-primary-inverted": "var(--border-primary-inverted)",
        "border-secondary": "var(--border-secondary)",
        "border-secondary-inverted": "var(--border-secondary-inverted)",
        ...
        "border-danger-secondary": "var(--border-danger-secondary)",
        ...
        "alpha-light-50": "var(--alpha-light-50)",
        "alpha-light-100": "var(--alpha-light-100)",
